...
#ifndef PROTOBUF_string_5fint_5flabel_5fmap_2eproto_INCLUDED
#define PROTOBUF_string_5fint_5flabel_5fmap_2eproto_INCLUDED
...
inline void InitDefaults() {
  InitDefaultsStringIntLabelMapItem();
  InitDefaultsStringIntLabelMap();
}
}  // namespace protobuf_string_5fint_5flabel_5fmap_2eproto
...
namespace google {
namespace protobuf {
template<> ::object_detection::protos::StringIntLabelMap* Arena::Create< ::object_detection::protos::StringIntLabelMap>(Arena*);
template<> ::object_detection::protos::StringIntLabelMapItem* Arena::Create< ::object_detection::protos::StringIntLabelMapItem>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace object_detection {
namespace protos {
...
class StringIntLabelMapItem : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:object_detection.protos.StringIntLabelMapItem) */ {
 public:
  ...
  inline StringIntLabelMapItem* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<StringIntLabelMapItem>(NULL);
  }

  StringIntLabelMapItem* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<StringIntLabelMapItem>(arena);
  }
 ...
 private:
  ...
  friend void ::protobuf_string_5fint_5flabel_5fmap_2eproto::InitDefaultsStringIntLabelMapItemImpl();
};
// -------------------------------------------------------------------
...
class StringIntLabelMap : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:object_detection.protos.StringIntLabelMap) */ {
 public:
  ...
  inline StringIntLabelMap* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<StringIntLabelMap>(NULL);
  }

  StringIntLabelMap* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<StringIntLabelMap>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_string_5fint_5flabel_5fmap_2eproto::TableStruct;
  friend void ::protobuf_string_5fint_5flabel_5fmap_2eproto::InitDefaultsStringIntLabelMapImpl();
};
// ===================================================================
...
#endif  // PROTOBUF_string_5fint_5flabel_5fmap_2eproto_INCLUDED
